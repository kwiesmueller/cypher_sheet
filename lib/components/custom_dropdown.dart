...
// Forked here to customize the menu and button format until
// https://github.com/flutter/flutter/issues/25151
// is resolved
...
class _DropdownButtonState<T> extends State<DropdownButton<T>>
  ...
  void _handleTap() {
    ...
    final Rect itemRect = itemBox.localToGlobal(Offset.zero,
        ...
        Size(widget.menuWidth ?? itemBox.size.width, itemBox.size.height);
  ...
  Widget build(BuildContext context) {
    ...
    final List<Widget> items = widget.selectedItemBuilder == null
        ? (widget.items != null && widget.menuWidth == null
